...
{
	# Open connections
    $SqlUserCredential = New-Object System.Management.Automation.PSCredential($ConConfig.MSSql.User.UserName, (ConvertTo-SecureString $ConConfig.MSSql.User.Password -AsPlainText -Force))
    ...
    Open-SqlConnection -ConnectionName "Source" -Server $Config.MSSql.Server -Database $Config.MSSql.Catalog -Credential $SqlUserCredential -TrustSSL
